...
from LedPotentiometerResource import LedPotentiometerResource
...
def main():
  ...
  resources[ 'led1' ] = LedPotentiometerResource( connector = LED1_PIN, \
                                     mqtt_client = mqtt_client, \
                                     sub_topic = LOCAL_IP + "/sensors/potentiometer0", \
                                     nuances_resolution = int( 1 ) )
