  ...
  def decode_payload_ascii_str( self, payload ):
    ...
    if( isinstance( payload, bytes ) ):
      try:
        ...
        self.logger.debug( "received payload does not contain anything convertible to bool" )
      except Exception:
        self.logger.debug( "Exception occurred while converting payload to bool" )
    else:
      self.logger.debug( "To decode message payload you have to use an array of bytes as input." )
